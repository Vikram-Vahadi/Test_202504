...
url = 'https://grabcad.com/library/tag/robot'
...
# Generate a random number between 0 & 556 for the 557 datasets present & store the link as a string
random_link = (dataset_list['Links'][np.random.randint(0, len(dataset_list)])
